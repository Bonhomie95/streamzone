...
export default function MovieHome() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setHeroIdx((i) => (i + 1) % Math.min(featured.length || 1, 5)),
      6000,
    );
  ...
  const displayMovies = (() => {
    ...
    if (filterType !== "all")
      list = list.filter((m) => m.mediaType === filterType);
    if (filterYear) list = list.filter((m) => m.year === filterYear);
    if (filterRating)
      list = list.filter((m) => m.rating >= parseFloat(filterRating));
    if (sortBy === "rating")
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to right, rgba(8,10,15,0.92) 35%, rgba(8,10,15,0.3) 70%, transparent), linear-gradient(to top, var(--bg) 0%, transparent 40%)",
            }}
          />
          <div
            style={{
          ...
          >
            ...
            <button
              onClick={() =>
                navigate(`/movies/watch/${hero.mediaType}/${hero.tmdbId}`)
              }
              style={{
                display: "inline-flex",
                alignItems: "center",
            ...
            {featured.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    i === heroIdx ? "var(--accent)" : "rgba(255,255,255,0.25)",
                  transition: "all 0.3s",
                  padding: 0,
                }}
              />
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "8px 10px" }}>
        ...
        <div
          style={{ fontSize: "0.68rem", color: "var(--text3)", marginTop: 3 }}
        >
          {movie.year}
        </div>
      </div>
