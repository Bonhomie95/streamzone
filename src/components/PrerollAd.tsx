  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: 'var(--text3)', fontSize: '0.75rem', letterSpacing: '0.08em',
      }}>
        AD · 300×250
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        {canSkip ? (
          <button onClick={onDismiss} style={{
            ...
            borderRadius: 8, padding: '8px 18px', fontSize: '0.85rem', fontWeight: 600,
            cursor: 'pointer',
          }}>
            <X size={14} />
            Skip Ad
          ...
          <div style={{
            ...
            borderRadius: 8, padding: '8px 18px', fontSize: '0.82rem', color: 'var(--text2)',
          }}>
            Skip in {countdown}s
          </div>
        )}
        <span style={{ fontSize: '0.72rem', color: 'var(--text3)' }}>Ad · Stream loading...</span>
      </div>
    </div>
  );
}
